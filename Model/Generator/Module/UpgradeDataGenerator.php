...
/**
 * Class UpgradeDataGenerator
 *
 * @package Krifollk\CodeGenerator\Model\Generator\Module
 */
class UpgradeDataGenerator extends AbstractGenerator
{
    ...
    protected function internalGenerate(
        ...
        $content = $this->codeTemplateEngine->render('module/upgradeData', [
            'namespace' => sprintf('%s\Setup', $moduleNameEntity->asPartOfNamespace())
        ]);
        $destinationFile = sprintf('%s/Setup/UpgradeData.php', $moduleNameEntity->asPartOfPath());
        $entityName = sprintf('\%s\Setup\UpgradeData', $moduleNameEntity->asPartOfNamespace());
