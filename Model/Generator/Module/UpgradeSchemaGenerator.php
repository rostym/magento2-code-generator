...
/**
 * Class UpgradeSchemaGenerator
 *
 * @package Krifollk\CodeGenerator\Model\Generator\Module
 */
class UpgradeSchemaGenerator extends AbstractGenerator
{
    ...
    protected function internalGenerate(
        ...
        $content = $this->codeTemplateEngine->render('module/upgradeSchema', [
            'namespace' => sprintf('%s\Setup', $moduleNameEntity->asPartOfNamespace())
        ]);
        $destinationFile = sprintf('%s/Setup/UpgradeSchema.php', $moduleNameEntity->asPartOfPath());
        $entityName = sprintf('\%s\Setup\UpgradeSchema', $moduleNameEntity->asPartOfNamespace());
