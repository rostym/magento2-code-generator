 ...
 */
class UninstallGenerator extends AbstractGenerator
{
    ...
    protected function internalGenerate(
        ...
        $content = $this->codeTemplateEngine->render('module/uninstall', [
            'namespace' => sprintf('%s\Setup', $moduleNameEntity->asPartOfNamespace())
        ]);
        $destinationFile = sprintf('%s/Setup/Uninstall.php', $moduleNameEntity->asPartOfPath());
        $entityName = sprintf('\%s\Setup\Uninstall', $moduleNameEntity->asPartOfNamespace());
